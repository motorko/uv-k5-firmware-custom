...
ENABLE_VFO_AUTO_COMPLETE					?= 1
ENABLE_SCAN_RANGES_ADAPTIVE_STEPS ?= 1
ENABLE_SINGLE_VFO_DISPLAY_MODE		?= 1
ENABLE_FLASHLIGHT_ONOFF_ONLY			?= 1
# kamilsss655 mods
...
ifeq ($(ENABLE_VFO_AUTO_COMPLETE),1)
	CFLAGS  += -DENABLE_VFO_AUTO_COMPLETE
endif
ifeq ($(ENABLE_SCAN_RANGES_ADAPTIVE_STEPS),1)
	CFLAGS  += -DENABLE_SCAN_RANGES_ADAPTIVE_STEPS
endif
ifeq ($(ENABLE_SINGLE_VFO_DISPLAY_MODE),1)
	CFLAGS  += -DENABLE_SINGLE_VFO_DISPLAY_MODE
endif
ifeq ($(ENABLE_FLASHLIGHT_ONOFF_ONLY),1)
	CFLAGS  += -DENABLE_FLASHLIGHT_ONOFF_ONLY
endif
